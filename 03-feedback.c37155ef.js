...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="feedback-form-state",o=document.querySelector(".feedback-form");function a(e){Array.prototype.forEach.call(o.elements,t=>{"submit"!=t.type&&""!=e[t.name]&&(t.value=e[t.name])})}let n=JSON.parse(localStorage.getItem(r));function l(e){Array.prototype.forEach.call(e,e=>{"submit"!=e.type&&(n[e.name]=e.value)}),console.log(111),localStorage.setItem(r,JSON.stringify(n))}null!=n?a(n):n={};const c=(0,e.default)(l,500);function u(e){c(e.currentTarget.elements)}function s(e){e.preventDefault(),e.currentTarget.reset(),localStorage.clear(),console.log(n)}o.addEventListener("input",u),o.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.c37155ef.js.map