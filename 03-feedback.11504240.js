...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="feedback-form-state",a=document.querySelector(".feedback-form");function n(e){Array.prototype.forEach.call(a.elements,t=>{"submit"!=t.type&&""!=e[t.name]&&(t.value=e[t.name])})}let o=JSON.parse(localStorage.getItem(r));function l(e){Array.prototype.forEach.call(e,e=>{"submit"!=e.type&&(o[e.name]=e.value)}),localStorage.setItem(r,JSON.stringify(o))}null!=o?n(o):o={};const c=(0,e.default)(l,500);function u(e){c(e.currentTarget.elements)}function s(e){e.preventDefault(),e.currentTarget.reset(),localStorage.clear(),console.log(o)}a.addEventListener("input",u),a.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.11504240.js.map