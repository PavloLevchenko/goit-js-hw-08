...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="feedback-form-state",a=500,n=document.querySelector(".feedback-form");function o(e){Array.prototype.forEach.call(n.elements,t=>{"submit"!=t.type&&""!=e[t.name]&&(t.value=e[t.name])})}let l=JSON.parse(localStorage.getItem(r));function c(e){Array.prototype.forEach.call(e,e=>{"submit"!=e.type&&(l[e.name]=e.value)}),localStorage.setItem(r,JSON.stringify(l))}null!=l?o(l):l={};const u=(0,e.default)(c,500);function s(e){u(e.currentTarget.elements)}function f(e){e.preventDefault(),e.currentTarget.reset(),localStorage.clear(),console.log(l)}n.addEventListener("input",s),n.addEventListener("submit",f);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.896e9266.js.map