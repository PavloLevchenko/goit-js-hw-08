...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="feedback-form-state",a=document.querySelector(".feedback-form");function n(e){Array.prototype.forEach.call(a.elements,t=>{"submit"!=t.type&&""!=e[t.name]&&(t.value=e[t.name])})}let l=JSON.parse(localStorage.getItem(r));function o(e){Array.prototype.forEach.call(e.currentTarget.elements,e=>{"submit"!=e.type&&(l[e.name]=e.value)}),localStorage.setItem(r,JSON.stringify(l))}null!=l?n(l):l={};const c=(0,e.default)(o,500,{leading:!0,trailing:!1});function u(e){e.preventDefault(),e.currentTarget.reset(),localStorage.clear(),console.log(l)}a.addEventListener("input",c),a.addEventListener("submit",u);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.02e6997d.js.map