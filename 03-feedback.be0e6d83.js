...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const n="feedback-form-state",o=document.querySelector(".feedback-form");function r(e){for(const t of o.elements)"submit"!=t.type&&""!=e[t.name]&&(t.value=e[t.name])}let a=JSON.parse(localStorage.getItem(n));function l(e){for(const t of e.currentTarget.elements)"submit"!=t.type&&(a[t.name]=t.value);localStorage.setItem(n,JSON.stringify(a))}null!=a?r(a):a={},console.log(a);const s=(0,e.default)(l,500,{leading:!0,trailing:!1});function u(e){e.preventDefault(),e.currentTarget.reset(),console.log(a)}o.addEventListener("input",s),o.addEventListener("submit",u);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.be0e6d83.js.map