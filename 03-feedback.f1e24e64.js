...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const n="feedback-form-state",r=document.querySelector(".feedback-form");function a(e){r.elements.foreach(t=>{"submit"!=t.type&&""!=e[t.name]&&(t.value=e[t.name])})}let o=JSON.parse(localStorage.getItem(n));function l(e){e.currentTarget.elements.foreach(e=>{"submit"!=e.type&&(o[e.name]=e.value)}),localStorage.setItem(n,JSON.stringify(o))}null!=o?a(o):o={},console.log(o);const u=(0,e.default)(l,500,{leading:!0,trailing:!1});function s(e){e.preventDefault(),e.currentTarget.reset(),console.log(o)}r.addEventListener("input",u),r.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f1e24e64.js.map